...
server.tool("minimax_image_01_generate", {
    ...
    const { prompt, aspect_ratio = "1:1", number_of_images = 1, prompt_optimizer = true, subject_reference } = args;
    try {
...
server.tool("minimax_image_01_generate_async", {
    ...
    const { prompt, aspect_ratio = "1:1", number_of_images = 1, prompt_optimizer = true, subject_reference, webhook, webhook_events_filter = ["completed"] } = args;
    try {
        // Prepare input for Replicate API
        const input = {
            prompt,
...
server.tool("minimax_image_01_get_prediction", {
...
server.tool("minimax_image_01_cancel_prediction", {
